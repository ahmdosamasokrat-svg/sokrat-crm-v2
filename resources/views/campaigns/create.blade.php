			...
			<div class="campaign-grid-2">
				...
				<div class="campaign-input-group">
					...
					<div class="campaign-input-wrapper">
						...
						>
						<span class="campaign-currency-prefix">{{ __('crm.pound') }}</span>
					</div>
				...
				<!-- Field 3: بداية الحملة (starts_at) -->
				<div class="campaign-input-group">
				...
				<!-- Field 5: صورة الحملة (image) - Col Span 2 -->
				<div class="campaign-input-group col-span-2">
	...
	>
		<div class="campaign-card-header">
			...
			<div class="picker-count-pill">
				...
				<span>المحدد: <strong x-text="selected.length"></strong> {{ __('crm.user_unit') }}</span>
			</div>
		</div>
