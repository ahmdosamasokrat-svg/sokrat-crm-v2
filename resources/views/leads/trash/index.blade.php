    ...
    <div class="trash-filters">
        <form method="GET" action="{{ route('v2.leads.trash.index') }}">
            <div>
                ...
                <input type="text" name="search" class="form-control" placeholder="{{ __('crm.lead_search_placeholder') }}" value="{{ $filters['search'] ?? '' }}">
            </div>
            ...
            <div style="display:flex; gap:8px;">
                ...
                @if(array_filter($filters))
                    <a href="{{ route('v2.leads.trash.index') }}" class="btn soft" style="height:38px; display:inline-flex; align-items:center; padding:0 12px;" title="{{ __('crm.reset') }}">
        ...
        <table class="trash-table">
            <thead>
                <tr>
                    ...
                    <th style="width:180px; text-align:center;">{{ __('crm.actions') }}</th>
                </tr>
            </thead>
            <tbody>
