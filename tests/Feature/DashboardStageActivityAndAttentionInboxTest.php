...
class DashboardStageActivityAndAttentionInboxTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->stageMeeting = PipelineStage::query()->create([
            'code' => 'meeting',
            'name_ar' => 'مقابلة',
            'position' => 1,
            'is_primary' => true,
        ...
        $this->statusMeeting = LeadStatus::query()->create([
        ...
        $this->stageOffer = PipelineStage::query()->create([
            'code' => 'quotation',
            'name_ar' => 'عرض سعر',
            'position' => 2,
            'is_primary' => true,
        ...
        $this->statusOffer = LeadStatus::query()->create([
